...
const handleSearchFlyTo = (coords)=>{
    ...
    if (coords) {
        // Add point
        new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$map$2f$features$2f$create$2d$route$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"]().constructMarker(mapInstance, "start", coords);
        // Fly to
        console.log(coords);
        mapInstance.flyTo({
            center: [
...
//# sourceMappingURL=src_app_813910ee._.js.map