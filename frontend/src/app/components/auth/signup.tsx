  ...
  return (
    <Dialog open={isOpen} as="div" className="relative z-50" onClose={onClose}>
      ...
      <div className="fixed inset-0 flex items-center bottom-40 justify-center p-4">
        <DialogPanel className="py-20 px-20 w-full max-w-lg rounded-xl bg-black/75 backdrop-blur-2xl p-6 shadow-xl transition-all transform scale-100 opacity-100">
