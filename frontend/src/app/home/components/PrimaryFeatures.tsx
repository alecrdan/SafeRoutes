    ...
    >
      <TabList className="relative z-10 order-last col-span-6 space-y-6">
        {features.map((feature, featureIndex) => (
          <div
            key={feature.name}
            className="relative rounded-2xl transition-colors  hover:bg-zinc-800/30"
          >
            {featureIndex === selectedIndex && (
              <motion.div
                layoutId="activeBackground"
                className="absolute inset-0 bg-zinc-950 text-stone-100"
    ...
    <>
      ...
      >
        {features.map((feature, featureIndex) => (
          <div
            key={featureIndex}
            ref={(ref: any) => ref && (slideRefs.current[featureIndex] = ref)}
...
export function PrimaryFeatures() {
  return (
    <section
      ...
      className="bg-stone-100 py-20 sm:py-32"
    >
      <Container>
